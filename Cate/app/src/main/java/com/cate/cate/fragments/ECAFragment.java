...
public class ECAFragment extends Fragment {
    ...
    public EmotionEnum prevEmotion = EmotionEnum.HAPPY;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        replayButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (ecaString != null){
                    sendToECAToSpeak(ecaString, prevEmotion);
                }
            }
        });
    ...
    public void sendToECAToSpeak(String sentence){
        ...
        VHMobileLib.executeSB("saySomething(characterName, \""+ sentence+"\", \"" + prevEmotion + "\")");
    }
     ...
     * @see VHMobileLib#executeSB(String)
     */
    public void sendToECAToSpeak(String sentence, EmotionEnum emotion){
        ecaString = sentence;

        prevEmotion = emotion;

        Log.d(TAG, "ECA speaks: " + sentence);
        VHMobileLib.executeSB("saySomething(characterName, \""+ sentence+"\", \"" + emotion + "\")");
    }
     ...
     */
    public void sendToECAToSPeak(int resID, EmotionEnum emotion){
        String sentence = getString(resID);
        ecaString = sentence;
        sendToECAToSpeak(sentence, emotion);
    }
    ...
    public void sendToECAToSPeak(int resID){
        String sentence = getString(resID);
        ecaString = sentence;
        sendToECAToSpeak(sentence, prevEmotion);
    }
     ...
     */
    public void sendToECAToEmote(EmotionEnum emotion, int i){
